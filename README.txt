...
Run the executable "Simulation" to perform the simulation prescribed in "params.txt". This will write out the data in a text file located in the "outputs/" directory. The environment variable OMP_NUM_THREADS should be used to set the desired number of processes.
